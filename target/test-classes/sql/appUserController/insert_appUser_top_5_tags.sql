...
values (0, 'tagDescription 0',N'trồng trọt', 0, 10);
insert into tag (tag_id, description, name, reputation, view_count)
values (1, 'tagDescription 1',N'chăn nuôi', 0, 20);
insert into tag (tag_id, description, name, reputation, view_count)
values (2, 'tagDescription 2',N'chăn nuôi 2', 0, 30);
insert into tag (tag_id, description, name, reputation, view_count)
values (3, 'tagDescription 3',N'chăn nuôi 3', 0, 5);
insert into tag (tag_id, description, name, reputation, view_count)
values (4, 'tagDescription 4',N'chăn nuôi 4', 0, 8);
