...
insert into app_user (user_id, anonymous, cv_url, ip_address, reputation, role, view_count, social_id)
values (3, 0, null , null, 0, 'ADMIN', 0, null);
...
-- Insert articles written by admin 3
insert into article (user_id, category, content, title, util_timestamp, view_count, article_id)
values (3, N'trồng trọt',N'Ẩm thực: đồ ăn hà nội khá chán, chắc do chỉ đa phần người Bắc nên em không hợp khẩu vị',
 N'người miền Nam sinh sống ở HN', '2012-02-22T18:10:00', 0, 1);
...
-- Comment for article id = 1
insert into comment (comment_id, content, util_timestamp, answer_id, user_id, article_id, question_id)
values (16, N'Câu bình luận đó là 10 cho câu hỏi số 1', null , null , 1, 1, null );
insert into comment (comment_id, content, util_timestamp, answer_id, user_id, article_id, question_id)
values (17, N'Câu bình luận đó là 11 cho câu hỏi số 1', null , null, 2, 1, null);
insert into comment (comment_id, content, util_timestamp, answer_id, user_id, article_id, question_id)
values (18, N'Câu bình luận đó là 12 cho câu hỏi số 1', null , null, 1, 1, null);
...
values (1, 'bucket_name', 'uploaded_file_name', 'uploaded_file_url_shown_onui', null , null);
insert into uploaded_file (id, bucket_name, uploaded_file_name, uploaded_file_url_shown_onui, article_id, question_id)
values (2, 'bucket_name', 'uploaded_file_name 2 ', 'uploaded_file_url_shown_onui 2', null, null);
