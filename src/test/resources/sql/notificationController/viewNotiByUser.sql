...
insert into notification
    (notification_id, delete_answer, delete_comment, delete_question,
     message, seen, util_timestamp, user_id, article_id, question_id)
values (2, 0, 0, 0, 'deleted question', 0, '2012-02-24T18:10:00', 1, null, 1);

insert into notification
    (notification_id, delete_answer, delete_comment, delete_question,
     message, seen, util_timestamp, user_id, article_id, question_id)
values (3, 0, 0, 0, 'deleted question', 0, '2012-02-24T18:10:00', 1, null, 1);

insert into notification
    (notification_id, delete_answer, delete_comment, delete_question,
     message, seen, util_timestamp, user_id, article_id, question_id)
values (4, 0, 0, 0, 'deleted question', 0, '2012-02-24T18:10:00', 1, null, 1);
