...
values (1, N'Ẩm thực: đồ ăn hà nội khá chán, chắc do chỉ đa phần người Bắc nên em không hợp khẩu vị',
 N'title 1', '2012-02-24T18:10:00', 15, 1);
insert into question (question_id, content, title, util_timestamp, view_count, user_id)
values (2, 'content 2', 'title 2', '2012-02-25T18:10:00', 30, 1);
insert into question (question_id, content, title, util_timestamp, view_count, user_id)
values (3, 'content 3', 'title 3', '2012-02-26T18:10:00', 20, 1);
insert into question (question_id, content, title, util_timestamp, view_count, user_id)
values (4, 'content 4', 'title 4', '2012-03-1T18:10:00', 10, 1);
insert into question (question_id, content, title, util_timestamp, view_count, user_id)
values (5, 'content 5', 'title 5', '2012-03-2T18:10:00', 50, 1);
